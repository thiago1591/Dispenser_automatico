...
void setar(){
   ...
   List keys = remedios.keys.toList();
...
void escrever(){
  for (int i=0;i<remedios.length;i++){
    List values = remedios.values.toList();
  dBRef.child('horarios').child('$i').set({
        '$i':values[i]
  });
}
}
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Adicionar Medicamento",style: TextStyle(color: Colors.white,fontSize: 23),),
      centerTitle: true,),
      ...
      Container(
        ...
        Column(children: <Widget>[
          ...
          Container(
            ...
            Column(children: <Widget>[
              SizedBox(height: 10,),
              Text("Nome do Medicamento",style: TextStyle(color: Colors.blue,fontSize: 23)),
              Container(
          ...
          Container(
            ...
            Column(children: <Widget>[
              SizedBox(height: 10,),
              Text("Horário do Medicamento",style: TextStyle(color: Colors.blue,fontSize: 23)),
              SizedBox(height: 20,),
              Text("Escolha um horário:",style: TextStyle(fontSize: 18,color:Colors.grey),),
                    ButtonTheme(
                      minWidth: 200,
                      height: 100,
                      child: FlatButton(
                  onPressed: ()async{
                    ...
                    setState(() {
                      a = "${selectedTime.hour}:${selectedTime.minute}";         
         ...
         child:Container(
           ...
           child: Column(
             children: <Widget>[
               ...
               Container(
                 ...
                 decoration: BoxDecoration(
                   image: DecorationImage(
                     image: AssetImage('images/alert.jpeg'),fit: BoxFit.fill
                   ),
               ...
               SizedBox(height: 2,),
               Text("Quer incluir outro remédio?",style: TextStyle(fontSize: 18,color: Colors.black87.withOpacity(0.5)),),
             SizedBox(height: 30,),
             Row(
               children: <Widget>[
          ...
          child: Column(
            children: <Widget>[
              ...
              Padding(
                ...
                child: Text(
                  "Por favor, insira o nome do medicamento e seu horário", style: TextStyle(
